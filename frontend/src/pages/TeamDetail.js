  ...
  return (
    <Box>
      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8} mb={8}>
        ...
        <Box bg="gray.800" p={5} rounded="md" shadow="lg" borderWidth={1} borderColor="gray.700">
          <Heading size="md" mb={4} color="white">Bench</Heading>
          
          {team.players.BENCH && team.players.BENCH.length > 0 ? (
            <Table variant="simple">
              <Thead bg="gray.900">
                <Tr>
                  <Th color="gray.400">Player</Th>
            ...
            <Flex 
              ...
              rounded="md"
            >
              <Text color="gray.400" mb={4}>No bench players</Text>
              <Button 
                size="sm" 
                colorScheme="teal"
                onClick={() => handleOpenAddPlayer('BENCH')}
              >
                Add Bench Player
              </Button>
            </Flex>
          ...
          {team.players.BENCH && team.players.BENCH.length < 3 && (
            <Button 
              mt={4} 
              size="sm" 
              colorScheme="teal" 
